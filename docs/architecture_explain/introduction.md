...
![Architecture schema](../assets/img/architecture_schema.png){ loading=lazy .img-medium}
/// figure-caption
...
-   **Tokenization and Embeddings**: Explores the basics of text tokenization, how input tokens are transformed into continuous vectors and how positional information is injected into the model.
-   **Encoder and Decoder**: Describes how attention layers and feed forward networks are stacked to build the full architecture. Briefly explores the role of the feed forward network.
